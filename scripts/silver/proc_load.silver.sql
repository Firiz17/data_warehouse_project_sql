...
Script purpose:
  ...
  -Clean and transforms data for each table
  - Truncate the silver tables before loading data from bronze tables.
  - Load the transformed data into the silver tables.
Usage examples: EXEC silver.load_silver;
---------------------------------------------------------
*/
